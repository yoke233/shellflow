...
export const defaultTestConfig = {
  main: { command: null, fontFamily: 'Menlo', fontSize: 13, fontLigatures: false, webgl: 'auto', padding: 8, scrollback: 20000, unfocusedOpacity: null },
  drawer: { fontFamily: 'Menlo', fontSize: 13, fontLigatures: false, webgl: 'auto', padding: 8, scrollback: 20000, unfocusedOpacity: 0.7 },
  navigation: {},
